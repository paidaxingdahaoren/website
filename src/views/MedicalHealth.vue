  ...
  <div class="body">
        ...
        <a-row>
          <a-col :span="12" :offset="1">
            <div class="banner_des">
              <h1 class="banner_title">医疗 | 数字健康化管理系统</h1>
    ...
    <div class="anchor_content">
      <div class="overview" id="overview">
        <div class="text_info">
          <div class="overview_title">选择适合你的医疗 | 数字健康化管理系统</div>
...
<script name="MedicalHealth" setup>
...
const forFreeTryList = ref({
  QRcode: require("@/assets/drugCode.png"),
  systemHref: "https://service.drugstore-cloud.com/opweb",
  visible: false,
});
