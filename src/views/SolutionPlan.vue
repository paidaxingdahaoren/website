  ...
  <div class="body">
        ...
        <a-row>
          <a-col :span="12" :offset="1">
            <div class="banner_des">
              <h1 class="banner_title">智慧云（药房 | 诊疗）管理系统</h1>
              ...
              <a-button
                ...
                ><a href="https://service.drugstore-cloud.com/miweb"
                target="_blank"> 免费试用</a></a-button
              >
    ...
    <div class="anchor_content">
      <div class="overview" id="overview">
        <div class="text_info">
          <div class="overview_title">选择适合你的智慧云药房管理系统</div>
        ...
        <div class="system_des">
          <a-row>
            <a-col :xxl="12" :lg="12" :xs="24" style="padding: 0 20px">
            ...
            <a-col :span="12" :lg="12" :xs="24"  style="padding: 0 20px">
              <img src="@/assets/heart.jpg" class="system_des_img" />
              <div class="system_des_textAlign">
                <div class="system_des_title">采用即装即用的解决方案</div>
                <div class="system_des_content">
...
<script name="SolutionPlan" setup>
